...
def on_spawn():
    global global_percentage, average_time, current_doors, late_flick, angler_timer, loan_angler, first_angler_spawn
    current_doors = 0
    global_percentage = 0
    average_time = 480
    late_flick = 0
...
while True:
    ...
    if not ridge:
        ...
        if global_percentage > 1:
            global_percentage = 1
        if not first_angler_spawn:
            disp_time1, disp_time2, global_percentage = 0, 0, 0
        os.system('cls')
